...
Route::group(['prefix' => $busadminRoute], function () {
      Route::get('/', [LoginController::class, 'create'])->name('business.login');
    ...
    Route::middleware(['auth_master','set.user.details', 'guard.session:masteradmins', 'prevent.back.history'])->group(function () {
        ...
        Route::get('states/{countryId}', [ProfilesController::class, 'getStates'])->name('business.states');
...
Route::post('/employee/file/store', [EmployeesController::class, 'storeFile'])->name('employee.file.store');
    ...
    Route::post('/timesheet', [TimeSheetController::class, 'store'])->name('timesheet.store');
           Route::post('/timesheet-data', [TimeSheetController::class, 'fetchTimesheetData'])->name('timesheet.data');
