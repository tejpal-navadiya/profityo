            ...
            <div class="row justify-content-between pad-3">
              <div class="col-md-3">
                <div id="customerInfo">
                  ...
                  <div class="edit_es_text" data-toggle="modal" data-target="#editcustor_modal_{{ $invoices->customer->sale_cus_id }}" data-id="{{ $invoices->customer->sale_cus_id }}">
                      <i class="fas fa-solid fa-pen-to-square mr-2"></i>Edit {{ $invoices->customer->sale_cus_first_name }} {{ $invoices->customer->sale_cus_last_name }}
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="sale_estim_customer_ref" id="estimatecustomerref"  placeholder="" value="{{ $invoices->sale_inv_customer_ref }}">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="hidden" id="hidden-total-days" name="sale_total_days" value="{{ $invoices->sale_total_days ?? '0' }}">
              ...
              ?>
                  ...
                  @foreach($invoicesItems as $item)
                    <tr class="item-row">
                        ...
                        <td><input type="number" class="form-control" name="items[][sale_estim_item_qty]" value="{{ $item->sale_inv_item_qty }}" min="1" placeholder="Enter item Quantity">
                        ...
                        <td>
                            <div class="d-flex">
                              <input type="text" name="items[][sale_estim_item_price]" class="form-control"
                                    aria-describedby="inputGroupPrepend" value="{{ $item->sale_inv_item_price }}" placeholder="Enter item Price">
                            </div>
            ...
            <div class="row pad-2">
              ...
              <div class="col-md-4">
                  ...
                  <input type="number" class="form-control form-controltext" name="sale_estim_item_discount"
                      aria-describedby="inputGroupPrepend" value="{{ $invoices->sale_estim_item_discount }}" min="1" placeholder="Enter a discount value">
              ...
              <div class="col-md-4">
                  ...
                  <table class="table total_table">
                      ...
                      <td id="sub-total">{{ $currencys->find($invoices->sale_currency_id)->currency_symbol }}{{ $invoices->sale_inv_sub_total }}</td>
                      </tr>
                      <tr>
                      <td>Discount :</td>
                      <td id="discount">{{ $currencys->find($invoices->sale_currency_id)->currency_symbol }}{{ $invoices->sale_inv_discount_total }}</td>
                      </tr>
                      <tr>
                      <td>Tax :</td>
            ...
            <div class="row pad-2">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea id="inputDescription" class="form-control" name="sale_estim_notes" rows="3" placeholder="Enter notes or terms of service that are visible to your customer">{{ $invoices->sale_inv_notes }}</textarea>
                </div>
              </div>
            </div>
            <!-- /.row -->
            ...
            <div class="row justify-content-between">
              <div class="col-md-12">
                <textarea id="inputDescription" name="sale_estim_footer_note" class="form-control" rows="3"
                  placeholder="Enter a footer for this invoice (e.g. tax information, thank you note)">{{ $invoices->sale_inv_footer_note }}</textarea>
              </div>
            </div>
            <!-- /.row -->
          </div>
