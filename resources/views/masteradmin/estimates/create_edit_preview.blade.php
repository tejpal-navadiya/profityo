                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body pad-1 text-center">
                                                    ...
                                                    <p class="company_details_text">Removing your logo will remove it from
                                                        ...
                                                        invoices and estimates. Are you sure you want to remove your
                                                        business logo?</p>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-md-7 float-sm-right">
                                    <input type="text"
                                        ...
                                        name="sale_estim_title" id="estimatetitle" value="{{ session('previewData')['sale_estim_title'] ?? old('sale_estim_title') }}"
                            ...
                            <div class="row justify-content-end">
                                <div class="col-md-7 float-sm-right px-10">
                                    ...
                                    <input type="text"
                                        ...
                                        name="sale_estim_summary" id="estimatesummary"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="estimatenumber">Estimate Number<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="sale_estim_number" id="estimatenumber"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sale_estim_customer_ref"
                                        id="estimatecustomerref" value="{{ session('previewData.sale_estim_customer_ref', old('sale_estim_customer_ref')) }}" placeholder="">
                ...
                <div class="row justify-content-between">
                    <div class="col-md-12">
                        <textarea id="inputDescription" name="sale_estim_footer_note" class="form-control" rows="3"
                            placeholder="Enter a footer for this estimate (e.g. tax information, thank you note)">{{ old('sale_estim_footer_note', $previewData['sale_estim_footer_note'] ?? '') }}</textarea>
                    </div>
                </div>
                <!-- /.row -->
            </div>
