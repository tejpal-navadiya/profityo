          ...
          <div class="tab-pane active" id="account-1">
            ...
            <div class="card">
              ...
              <div class="card-body2">
                ...
                <table class="table table-hover dashboard_table">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="sorting_disabled text-right" data-orderable="false" style="width: 100px;">Actions</th>
                                ...
                                @foreach ($list[$asset->chart_menu_id] as $account)
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                          ...
                                          @if ($account->archive_account == 1)

                                            <span style="padding: 5px 10px; font-size: 14px; border-radius: 4px; color: #fff; background-color: #053A51;">Archived</span>
                                              ...
                                              <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="form-check d-flex align-items-baseline">
                                                      ...
                                                      <input type="hidden" name="archive_account" value="0">
                      ...
                      @csrf
                          ...
                          <div class="row pxy-15 px-10">
                            ...
                            <div class="form-group">
                              ...
                              <select id="assetaddaccountType" data-id="" name="acc_type_id" class="form-control">
                              ...
                              <span id="assetaddaccountTypeError" class="text-danger mt-2" style="display:none;">Please select account type.</span>
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control from-select select2 @error('currency_id') is-invalid @enderror" id="assetcurrencyId" name="currency_id" style="width: 100%;">
                                    ...
                                    <option value="{{ $cur->id }}" data-symbol="{{ $cur->currency_symbol }}" {{ $cur->id == old('sale_currency_id', $currency->id) ? 'selected' : '' }}>
                            ...
                            @if (isset($list[$lccard->chart_menu_id]))
                                ...
                                @foreach ($list[$lccard->chart_menu_id] as $liabilities)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $liabilities->sale_acc_desc }} 

                                          @if ($liabilities->archive_account == 1)

                                            <span style="padding: 5px 10px; font-size: 14px; border-radius: 4px; color: #fff; background-color: #6c757d;">Archived</span>
                            ...
                            @if (isset($list[$incomes->chart_menu_id]))
                                ...
                                @foreach ($list[$incomes->chart_menu_id] as $incm)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $incm->sale_acc_desc }} 

                                          @if ($incm->archive_account == 1)
                            ...
                            @if (isset($list[$expense->chart_menu_id]))
                                ...
                                @foreach ($list[$expense->chart_menu_id] as $exp)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $exp->sale_acc_desc }} 

                                          @if ($exp->archive_account == 1)
          ...
          @csrf
              ...
              <div class="row pxy-15 px-10">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control from-select select2 @error('acc_type_id') is-invalid @enderror" id="accountType" name="acc_type_id" style="width: 100%;">
                  ...
                  <span id="addaccountTypeError" class="text-danger mt-2" style="display:none;">Please select account type.</span>
    ...
    const formsConfig = [
...

        {
            ...
            fields: [
                ...
                { selector: '#accountType', errorSelector: '#addaccountTypeError' }
...

        {
            ...
            fields: [
                ...
                { selector: '#assetaddaccountType', errorSelector: '#assetaddaccountTypeError' }
