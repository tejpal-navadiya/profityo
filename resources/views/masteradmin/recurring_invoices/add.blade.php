@extends('masteradmin.layouts.app')
  <title>Profityo | New Recurring Invoice</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <form id="items-form" action="{{ route('business.recurring_invoices.store') }}" method="POST">
        @csrf
        <!-- /.card-header -->
        <div class="card-body">
  ...
  @endif
      ...
      <div class="row px-10">
        ...
        @endforeach
            ...
            <td><input type="number" class="form-control" name="items[][sale_estim_item_qty]" min="1"
