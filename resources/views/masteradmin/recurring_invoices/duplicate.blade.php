...
<title>Profityo | Edit Recurring Invoices</title>
@if(isset($access['update_recurring_invoices']) && $access['update_recurring_invoices']) 
@section('content')
  ...
  <section class="content px-10">
    <div class="container-fluid">
      ...
      <div class="card card-default">
        ...
        <form id="items-form" action="{{ route('business.recurring_invoices.duplicateStore', ['id' => $reinvoices->sale_re_inv_id]) }}"
        method="POST">
          @csrf
          @method('Patch')
          <!-- /.card-header -->
                ...
                <div class="row justify-content-end">
                  <div class="col-md-7 float-sm-right px-10">
                    <input type="text" class="form-control text-right" name="sale_estim_summary" id="estimatesummary"
                      placeholder="Summary (e.g. project name, description of invoice)" value="{{ $reinvoices->sale_re_inv_summary }}">
                  </div>
                </div>
                <div class="px-10">
                ...
                <div class="row in-number-row">
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" name="sale_estim_number" id="estimatenumber" placeholder="" value="{{ $newId }}" disabled>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="sale_estim_customer_ref" id="estimatecustomerref"  placeholder="" value="{{ $reinvoices->sale_re_inv_customer_ref }}">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select name="sale_re_inv_payment_due_id" id="sale_re_inv_payment_due_id" class="form-control select2" style="width: 100%;">
                        ...
                        <option value="45" {{ $reinvoices->sale_re_inv_payment_due_id == 45 ? 'selected' : '' }}>Within 45 Days</option>
                        <option value="60" {{ $reinvoices->sale_re_inv_payment_due_id == 60 ? 'selected' : '' }}>Within 60 Days</option>
                        <option value="90" {{ $reinvoices->sale_re_inv_payment_due_id == 90 ? 'selected' : '' }}>Within 90 Days</option>
                      </select>
                    ...
                    // dd($estimatesCustomizeMenu);
                      ...
                      @php
                          ...
                          foreach ($HideMenus as $hmenu) {
                              $isChecked1[$hmenu->mname] = (old($hmenu->mname) || $reinvoicesCustomizeMenu->where('mname', $hmenu->mname)->first()?->is_access);
                          }
                      @endphp

                      @foreach($reinvoicesCustomizeMenu as $menu)
                        @if($menu->is_access == 1 && $menu->re_inv_cust_menu_title !== "on")
                            @php
                            $hasData = true;
                              //dd($isChecked);
                                $headerText =  $menu->re_inv_cust_menu_title ?? ucfirst($menu->mname);
                        ...
                        <td>
                            <div>
                                ...
                                <input type="text" class="form-control px-10" name="items[][sale_estim_item_desc]"
                                    placeholder="Enter item description" value="{{ $item->sale_re_inv_item_desc }}">
                                <span class="error-message" id="error_items_0_sale_estim_item_desc" style="color: red;"></span>
                            </div>
                        </td>
                        <td><input type="number" class="form-control" name="items[][sale_estim_item_qty]" value="{{ $item->sale_re_inv_item_qty }}" min="1" placeholder="Enter item Quantity">
                        ...
                        <td>
                            <div class="d-flex">
                              <input type="text" name="items[][sale_estim_item_price]" class="form-control"
                                    aria-describedby="inputGroupPrepend" value="{{ $item->sale_re_inv_item_price }}" placeholder="Enter item Price">
                            </div>
            ...
            <div class="row pad-2">
              ...
              <div class="col-md-4">
                  ...
                  <input type="number" class="form-control form-controltext" name="sale_estim_item_discount"
                      aria-describedby="inputGroupPrepend" value="{{ $reinvoices->sale_re_estim_item_discount }}" min="1" placeholder="Enter a discount value">
                  <select class="form-select form-selectcurrency" id="sale_estim_discount_type" name="sale_estim_discount_type" >
                      <option value="1" {{ $reinvoices->sale_inv_discount_type == 1 ? 'selected' : '' }} >{{ $currencys->find($reinvoices->sale_currency_id)->currency_symbol }}</option>
                      <option value="2" {{ $reinvoices->sale_re_inv_discount_type == 2 ? 'selected' : '' }}>%</option>
                  </select>
                  </div>
              </div>
              <div class="col-md-4">
                  ...
                  <table class="table total_table">
                      ...
                      <td id="sub-total">{{ $currencys->find($reinvoices->sale_currency_id)->currency_symbol }}{{ $reinvoices->sale_re_inv_sub_total }}</td>
                      </tr>
                      <tr>
                      <td>Discount :</td>
                      <td id="discount">{{ $currencys->find($reinvoices->sale_currency_id)->currency_symbol }}{{ $reinvoices->sale_re_inv_discount_total }}</td>
                      </tr>
                      <tr>
                      <td>Tax :</td>
                      <td id="tax">{{ $currencys->find($reinvoices->sale_currency_id)->currency_symbol }}{{ $reinvoices->sale_re_inv_tax_amount }}</td>
                      </tr>
                      <tr>
                      <td><strong>Total:</strong></td>
                      <td id="total"><strong>{{ $currencys->find($reinvoices->sale_currency_id)->currency_symbol }}{{ $reinvoices->sale_re_inv_final_amount }}</strong></td>
                      </tr>
                  </table>
            ...
            <div class="row pad-2">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea id="inputDescription" class="form-control" name="sale_estim_notes" rows="3" placeholder="Enter notes or terms of service that are visible to your customer">{{ $reinvoices->sale_re_inv_notes }}</textarea>
                </div>
              </div>
            </div>
            <!-- /.row -->
            ...
            <div class="row justify-content-between">
              <div class="col-md-12">
                <textarea id="inputDescription" name="sale_estim_footer_note" class="form-control" rows="3"
                  placeholder="Enter a footer for this invoice (e.g. tax information, thank you note)">{{ $reinvoices->sale_re_inv_footer_note }}</textarea>
              </div>
            </div>
            <!-- /.row -->
          </div>
...
<div class="modal fade" id="editcolum" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-content">
      ...
      <form method="post" id="estimateForm" action="{{ route('reinvoicesmenus.update') }}" class="mt-6 space-y-6"
                    ...
                    @foreach($menu->children as $child)
                        @if($child->mtitle == 'Other')
                            <div class="col-md-3">
                                ...
                                @php
                                    $item = $reinvoiceCustomizeMenu->where('mname', $menu->mname)->first();
                                    ...
                                    if($item)
                                    {
                                        ...
                                        if ($item->mtitle == 'price other' || $item->mtitle == 'amount other' || $item->mtitle == 'item other' ||  $item->mtitle == 'units other') {
                                            $value = $item->re_inv_cust_menu_title ?? '';
                                            //dd($value);
                                        } 
                                      }
                                @endphp
                                    ...
                                    <input type="radio" id="{{ $child->mname }}" name="{{ $menu->mtitle }}" 
                                        value="{{ $child->mname }}" 
                                        {{ ($reinvoiceCustomizeMenu->where('mname', $menu->mname)->first()?->re_inv_cust_menu_title == $value ) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="icheck-primary">
                                    <input type="radio" id="{{ $child->mtitle }}" name="{{ $menu->mtitle }}" 
                                        value="{{ $child->mtitle }}" 
                                        {{ (old($menu->mtitle) == $child->mtitle || $reinvoiceCustomizeMenu->where('mname', $menu->mname)->first()?->re_inv_cust_menu_title == $child->mtitle) ? 'checked' : '' }}>
                ...
                <div class="col-md-3">
                    <div class="icheck-primary">
                        ...
                        <input type="checkbox" id="{{ $hmenu->mname }}" name="{{ $hmenu->mname }}" 
                            {{ (old($hmenu->mname) || $reinvoiceCustomizeMenu->where('mname', $hmenu->mname)->first()?->is_access) ? 'checked' : '' }}>
                ...
                <div class="col-md-12">
                    <div class="icheck-primary">
                        ...
                        <input type="checkbox" id="{{ $dmenu->mname }}" name="{{ $dmenu->mname }}" 
                            {{ (old($dmenu->mname) || $reinvoiceCustomizeMenu->where('mname', $dmenu->mname)->first()?->is_access) ? 'checked' : '' }}>
            ...
            @foreach($HideSettings as $smenu)
                <div class="icheck-primary">
                    ...
                    <input type="checkbox" id="{{ $smenu->mname }}" name="{{ $smenu->mname }}" 
                        {{ (old($smenu->mname) || $reinvoiceCustomizeMenu->where('mname', $smenu->mname)->first()?->is_access) ? 'checked' : '' }}>
...
<div class="modal fade" id="editcustor_modal_{{ $reinvoices->customer->sale_cus_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
